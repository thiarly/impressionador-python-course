...
venda= float(input('Digite o valor de Iphone vendidos: '))
meta = 50000
demitir_vendedor = 30000

if venda >= meta:
   print(f'Showww, batemos a meta, vendemos {venda} unidades') 

elif venda < meta and meta < demitir_vendedor:
    print(f'Não batemos a meta, mas chegamos próximo, vendemos {venda} unidades')
    
elif venda < demitir_vendedor:
    print(f'NÃO BATEMOS A META, VOCÊ ESTÁ FORA! VENDEMOS APENAS {venda}')
